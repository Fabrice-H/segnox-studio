...
export const OFFERS = [
  {
    name: "Essentiel",
    tagline: "Vous existez enfin proprement en ligne.",
    features: [
      "Site pro qui vous présente bien",
      "Visible sur Google",
      "WhatsApp pré-rempli",
      "Mise en ligne 3–7 j",
    ],
  ...
  {
    name: "Business",
    tagline: "Votre site qualifie vos clients automatiquement.",
    features: [
      "Tout l'Essentiel",
      "Formulaire de qualification",
      "Réponses automatiques 24/7",
      "Clients triés avant WhatsApp",
    ],
    highlighted: true,
  ...
  {
    name: "Complet",
    tagline: "Le système complet + suivi mensuel inclus.",
    features: [
      "Tout Business",
      "Paiements intégrés",
      "Relances automatiques",
      "Abonnement inclus 3 mois",
    ],
    highlighted: false,
  },
];
