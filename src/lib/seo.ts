...
export const siteConfig = {
  ...
  phone: "+225 07 78 67 17 17",
  phoneFormatted: "+225 07 78 67 17 17",
  ...
  social: {
    whatsapp: "https://wa.me/2250778671717",
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description: "Site clair et professionnel, visible sur Google, lien WhatsApp pré-rempli, mise en ligne en 3-7 jours",
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description: "Tout l'Essentiel + Assistant IA 24/7, relances automatiques, présence réseaux sociaux",
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description: "Tout Business + Paiements intégrés (Wave, Orange Money), campagnes pub, optimisation continue",
...
export function generateServiceJsonLd(serviceName: string, serviceDescription: string) {
  return {
    "@context": "https://schema.org",
    "@type": "Service",
