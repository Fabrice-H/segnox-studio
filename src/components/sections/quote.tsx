...
export function QuoteSection() {
  return (
    <section className="relative bg-dark overflow-hidden">
      ...
      <RevealOnScroll className="relative max-w-[900px] mx-auto px-6 py-[88px] text-center">
        <blockquote className="font-heading font-extrabold text-[clamp(24px,4vw,40px)] leading-[1.25] tracking-[-0.02em] text-white text-balance">
          Votre activité mérite mieux qu&apos;une page Facebook oubliée.{" "}
          <span className="text-gold-lighter">
            Vos clients vous jugent en ligne avant de vous rencontrer.
          </span>
        </blockquote>
      </RevealOnScroll>
    </section>
